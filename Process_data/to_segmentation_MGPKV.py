# Create files for Anatomical landmark Segmentation Tasks
import json
import os
from PIL import Image

# Path to save files
path_image = '/workspace/ailab/phucnd/Segmentation_MGPKV_data/imgs'
path_masks = '/workspace/ailab/phucnd/Segmentation_MGPKV_data/masks'

# Path to json files
path_json_label = '/workspace/ailab/phucnd/04102023_Nhom_benh/json_label_MGPKV_final.json'
# path_json_label = '/workspace/ailab/phucnd/04102023_Nhom_chung/json_label_MGPKV_final.json'
        ...
        for k in j['videos']:
            for l in k['images']:
                if (i['object_id'] == l['image_id']):
                    directory_img = os.path.join('/workspace/ailab/phucnd/04102023_Nhom_benh/imgs', j['id'],
                                                 k['video_id'], f'{l["image_id"]}.png')
                    directory_mask = os.path.join('/workspace/ailab/phucnd/04102023_Nhom_benh/masks_MGPKV', j['id'],
                                                  k['video_id'], f'{l["image_id"]}.png')
