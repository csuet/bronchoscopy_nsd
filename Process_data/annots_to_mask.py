...
label_MGPKV = ["b2cc70ea-01f6-4389-a3a3-6222600a445a", "ce08e883-ddd2-4639-aa05-9fdac022f545",
...
# Labels of Lesions
label_TTKV = ["a2ff1ceb-280b-410d-9ddc-82cb4a2e2ccb", "ff9241a0-a760-49d4-b34d-54f20ddedb0c",
...
for i in data_objects:
    for j in i['videos']:
        for k in j['images']:
            ...
            path = os.path.join('/workspace/ailab/phucnd/04102023_Nhom_benh/masks_TTKV', i['id'], j['video_id'])
