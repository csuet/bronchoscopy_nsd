...
path_image = '/workspace/ailab/phucnd/Segmentation_TTKV_final_data/imgs'
path_masks = '/workspace/ailab/phucnd/Segmentation_TTKV_final_data/masks'

# path_json_label = '/workspace/ailab/phucnd/25092023_109_Nhom_chung/json_label_TTKV_final.json'
path_json_label = '/workspace/ailab/phucnd/25092023_112_Nhom_benh/json_label_TTKV_final.json'
        ...
        for k in j['series']:
            for l in k['images']:
                if (i['object_id'] == l['object_id']):
                    ...
                    directory_mask = os.path.join('/workspace/ailab/phucnd/25092023_112_Nhom_benh/masks_TTKV',j['object_id'],k['object_id'],f'{l["object_id"]}.png')
